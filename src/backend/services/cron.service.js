...
const LIGHT_DURATION_MS = 10000;
const ALERT_COOLDOWN_MS = 15 * 60 * 1000;
let lastAlertSentMap = { temp: 0, humi: 0, light: 0, hardware_error: 0 };

let lightAlert = { isAlerting: false, startTime: null };
